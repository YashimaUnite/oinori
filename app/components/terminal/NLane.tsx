...
type NLaneProps = z.infer<typeof nLaneSchema>;

class NLane extends TrackLane {
  lanes: TrackLane[];
...
const nLaneInstance = new NLane({ lanes: Array.from({ length: 8 }, (_, i) => ({ id: i, name: `Lane ${i + 1}` })) });

export default nLaneInstance;
